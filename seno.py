...
print(30*"*")
print("Programa para calcular o \033[1:31mSeno\033[m de um ângulo entre 0° e 360°")
...
for i in range(3,1000000000,2):
    contador += 1
    soma = soma + (((-1)**contador)*(angulo**i)/math.factorial(i))
    if(contador == n):
        break
...
if(soma < 0.001 and soma > 0):
    soma = 0
print(f"O \033[1:31mSeno\033[m do ângulo é \033[1:32m{soma}")